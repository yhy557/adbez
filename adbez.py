...
load_clicked = 0
def called_test_function(event):
    global load_clicked
    load_clicked += 1
    print(f"clicked test: {load_clicked}")
    if load_clicked == 1:
        load1()
    elif load_clicked == 2:
        load2()
...
def load1():
    print("Tıklandı-----------------------------------------")
    root.update_idletasks()
    tab2_load_more_btn.pack_forget()
    tab2_seperate_scroll_LOAD.pack_forget()
    ...
    root.after(100, lambda: tab2_seperate_scroll_LOAD.pack())
    root.after(101, lambda: tab2_load_more_btn.pack())
#SEPERATE
def load2():
    print("Tıklandı22222-----------------------------------------")
    root.update_idletasks()
...
tab2_load_more_btn.bind("<Button-1>", called_test_function)
