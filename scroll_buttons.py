...
class Buttons:
    ...
    def called_test_function(self):
        ...
        if self.load_clicked in DOWNLOAD_STEPS:
            start, end, is_last = DOWNLOAD_STEPS[self.load_clicked]
            self.load_all(start, end, is_last=is_last)
        else:
